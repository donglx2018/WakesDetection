...
while i1 < m % m = number of timesteps in the considered day
     ...
     switch flag
      ...
      if (i2 - i1) > 25
          ...
          for iR = rInd % loop across different range gates
              ...
              if rho(1,wakeTemp(1))==min(rho(1,wakeTemp(1)),rho(2,wakeTemp(2)),rho(3,wakeTemp(3)),rho(4,wakeTemp(4)))
                  seltent=1;
                  bHatRec = bHatRecTemp(1,:);
                  ciRec = ciRecTemp(1,:);
                  wake = wakeTemp(1);
              elseif rho(2,wakeTemp(2))==min(rho(1,wakeTemp(1)),rho(2,wakeTemp(2)),rho(3,wakeTemp(3)),rho(4,wakeTemp(4)))
                  seltent=2;
                  bHatRec = bHatRecTemp(2,:);
                  ciRec = ciRecTemp(2,:);
                  wake = wakeTemp(2);
              elseif rho(3,wakeTemp(3))==min(rho(1,wakeTemp(1)),rho(2,wakeTemp(2)),rho(3,wakeTemp(3)),rho(4,wakeTemp(4)))
                  seltent=3;
              ...
              if wake==2
                 ...
                 if bHatRec(ind)<0.5/4 || bHatRec(ind-8)<iR*0.03 || 4*bHatRec(ind)>(max(yorig)-min(yorig))/2
                     bHatRec(ind)=NaN;
                     bHatRec(ind-4)=NaN;
                     bHatRec(ind-8)=NaN; 
                 end
                 ind=13; % 3rd detected wake
                 if (bHatRec(ind)<0.5/4 || bHatRec(ind-8)<iR*0.04 || 4*bHatRec(ind)>(max(yorig)-min(yorig))/2) && iR<44-1
                 ...
                 if (bHatRec(ind)<0.5/4 || bHatRec(ind-8)<iR*0.05 || 4*bHatRec(ind)>(max(yorig)-min(yorig))/2) && iR<44-2
                     bHatRec(ind)=bHatRec(ind+1);
                     bHatRec(ind-4)=bHatRec(ind-3);
                     bHatRec(ind-8)=bHatRec(ind-7);
                 ...
                 if (bHatRec(ind)<0.5/4 || bHatRec(ind-8)<iR*0.046 || 4*bHatRec(ind)>(max(yorig)-min(yorig))/2) && iR<44-2
                     bHatRec(ind)=bHatRec(ind+1);
                     bHatRec(ind-4)=bHatRec(ind-3);
                     bHatRec(ind-8)=bHatRec(ind-7);
                     bHatRec(ind+1)=bHatRec(ind+2);
